        ...
        <div className="flex items-center relative">
          <Link href={'/cart'}>
            <div className="flex">
              ...
              <span className="flex justify-center items-center w-[22px] h-[22px] top-[-9px] border focus:border-sky-500 right-[-13px] text-center rounded-[50%] bg-red-600 text-white absolute">
                {totalCart}
              </span>
            </div>
